...
devicemanager device update <id> --name <n>            # 编辑设备
...
devicemanager device alert-rule create --name <n> --metric <m> --condition <c> --threshold <t>  # 创建规则
devicemanager device alert-rule update <id>            # 更新规则
...
devicemanager system user create --name <n> --email <e> --password <p>  # 创建用户
devicemanager system user update <id> --name <n>       # 更新用户
...
devicemanager system permission update <id> --name <n> # 更新权限组
...
devicemanager system org update <id> --name <n>        # 更新组织信息
